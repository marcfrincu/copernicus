 ...
 *
 *	URL: http://www.spacesimulator.net/tut4_3dsloader.html
 *
 */
...
Combined Linux and Windows by Marc Frincu. Also integrated support for rendering
mail: mfrincu@info.uvt.ro
...
char load_3DS (obj_type_ptr p_object, char *p_filename)
{
...
void draw_3DS ( obj_type_ptr object )
{
   ...
   glBindTexture(GL_TEXTURE_2D, object->id_texture); // We set the active texture
	...
	for ( long l_index=0; l_index<object->polygons_qty; l_index++ )
	{
		//----------------- FIRST VERTEX -----------------
...
//		printf ("%f %f %f\n",object->vertex[ object->polygon[l_index].a ].x, object->vertex[ object->polygon[l_index].a ].y, object->vertex[ object->polygon[l_index].a ].z);
		//----------------- SECOND VERTEX -----------------
	...
	//	printf ("%f %f %f\n",object->vertex[ object->polygon[l_index].b ].x, object->vertex[ object->polygon[l_index].b ].y, object->vertex[ object->polygon[l_index].b ].z)        ;
		//----------------- THIRD VERTEX -----------------
		...
		//printf ("%f %f %f\n",object->vertex[ object->polygon[l_index].c ].x, object->vertex[ object->polygon[l_index].c ].y, object->vertex[ object->polygon[l_index].c ].z);
	}
	glEnd();
